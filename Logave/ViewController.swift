...
class ViewController: UIViewController, NSFetchedResultsControllerDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Logave", withExtension: "momd")!
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "BSUIR.Logave" in the application's documents Application Support directory.
